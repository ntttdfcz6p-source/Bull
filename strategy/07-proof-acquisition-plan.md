...
| Manufacturing standard (GMP-certified facility) | Request the EU GMP certificate from DAT Supply via their client portal — confirmed available on request, not yet requested | Ops | Available, not yet obtained |
| Third-party lab testing | Request the batch-specific Certificate of Analysis once a production batch exists — confirmed available on request | Ops/QA | Available, not yet obtained |
| Ingredient sourcing documentation | Request the Compliance Dossier (references EU Reg. 1924/2006 and 432/2012) from the supplier portal | Product | Available, not yet obtained |
| Expert commentary | Engage a licensed nutritionist/physician for a reviewed quote (with credentials disclosed) | Marketing/Legal | Not started |
