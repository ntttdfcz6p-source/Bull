...
- Per-serving actives (confirmed): **Saffron Extract 30 mg, Panax Ginseng Extract 100 mg, Maca Root Extract 300 mg, Pyridoxine Hydrochloride (Vitamin B6) 2 mg.** These can now replace the `[PLACEHOLDER amount]` values in `sections/ingredient-education.liquid` — done in this update.
